...
/****** Object:  Database [DoAn]    Script Date: 5/5/2023 8:31:45 PM ******/
CREATE DATABASE [DoAn]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DSSV', FILENAME = N'E:\Programing System\MSSQL15.SQLEXPRESS\MSSQL\DATA\DSSV.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DSSV_log', FILENAME = N'E:\Programing System\MSSQL15.SQLEXPRESS\MSSQL\DATA\DSSV_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
